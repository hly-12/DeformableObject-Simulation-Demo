...
public class GPUPBDSolving : MonoBehaviour
{
    public enum MyModel
    {
        IcoSphere_low,
    ...
    public float convergence_factor = 1.0f;
    ...
    public string directory = "E:/Labdata/Unity/PBDDeformation/20221206/";
    public string volumeFileName = "dc";
    ...
    private ComputeBuffer projectedPositionsUintBuffer;
    ...
    private int applyExplicitEulerKernel; //add external force
    ...
    private int averageConstraintDeltasKernel; //**testing whether to use or not//
    ...
    void setupMeshData()
    {
        ...
        //distanceConstraint = LoadModel.springs;
    ...
    private void setupComputeBuffer()
    {
        ...
        projectedPositionsUintBuffer = new ComputeBuffer(nodeCount, sizeof(uint) * 3);
        projectedPositionsUintBuffer.SetData(deltaPositionArray);
    ...
    private void setupComputeShader()
    {
        ...
        computeShaderobj.SetBuffer(applyExplicitEulerKernel, "ProjectedPositionsUint", projectedPositionsUintBuffer);

        //Kernel #2

        //computeShaderobj.SetBuffer(satisfyDistanceConstraintKernel, "ProjectedPositions", projectedPositionsBuffer);
        //computeShaderobj.SetBuffer(satisfyDistanceConstraintKernel, "ProjectedPositionsUint", projectedPositionsUintBuffer);
        //computeShaderobj.SetBuffer(satisfyDistanceConstraintKernel, "distanceConstraints", distanceConstraintsBuffer);
        //computeShaderobj.SetBuffer(satisfyDistanceConstraintKernel, "Velocities", velocitiesBuffer);
        ...
        computeShaderobj.SetBuffer(floorCollisionKernel, "ProjectedPositionsUint", projectedPositionsUintBuffer);
        ...
        computeShaderobj.SetBuffer(updatePositionsKernel, "ProjectedPositionsUint", projectedPositionsUintBuffer);
    ...
    void Start()
    {
        ...
        print("bending :: " + bendingCount);

        //print(transform.InverseTransformPoint(new Vector3(0, 2, 0)));
    ...
    void dispatchComputeShader()
    {
        ...
        ////damp velocity() here
        //computeShader.Dispatch(projectConstraintDeltasKernel, (int)Mathf.Ceil(nodeCount / 1024.0f), 1, 1);
        ...
        //print((int)Mathf.Ceil(nodeCount / 1024.0f));
    }
    ...
    private void OnDestroy()
    {
        if (this.enabled)
        {
            ...
            projectedPositionsUintBuffer.Dispose();
